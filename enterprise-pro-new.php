...
<body class="enterprise_color">
   ...
   <!-- banner -->
    ...
    <section>
        <div class="container">
            <div class="hdng text-center">
                <h2 class="blue_mnhdng">Unique Learning Tracks</h2>
                <p>Future-ready programs to upskill corporates, individuals and institutions.</p>
            </div>
            <div class="progrm_slides">
                <div class="prsld">
                    <div class="prflx" data-aos="fade-up">
                        <div class="prgimg">
                            <div class="prg_mnimg">
                                <img src="<?php echo $base_url;?>assets/imgs/enterprise/weofr.webp" alt="We Offer" width="434" height="434">
                            </div>
                                <div class="sbimg">
                                <img src="<?php echo $base_url;?>assets/imgs/enterprise/wesbon.webp" alt="sbimg" width="80" height="80">
                            </div>
                        </div>
                        <div class="prgdtls">
                            <div class="prghd">
                               <h2> Executive Education Programs</h2>
                               <p>Tailored training solutions for corporates to enhance leadership, functional, and technical capabilities.</p>
                            </div>
                            <div class="prgtgs">
                                <span>In-Person</span>
                                <span>Online</span>
                            ...
                            <div class="prgcrds">
                                <div class="wefr">
                                    ...
                                    <p>Customized programs across functional, technical, business, and leadership domains.</p>
                                </div>
                                <div class="wefr">
                                    <h3>Outcomes</h3>
                                    <p>Stronger leadership, business foundations, and peer networking opportunities.</p>
                                </div>
                            </div>
                            <a class="primary_btn" href="#" tabindex="0"><span>Enquire Now</span> <svg width="10" height="15" viewBox="0 0 10 19" fill="none" xmlns="https://www.w3.org/2000/svg">
                    ...
                    <div class="prflx" data-aos="fade-up">
                        <div class="prgdtls">
                            <div class="prghd">
                               ...
                               <p>Flexible online learning paths designed for professionals to upgrade skills in BFSI, Fintech, and Analytics.</p>
                            </div>
                            <div class="prgtgs">
                                <span>In-Person</span>
                                <span>Online</span>
                                <span>EdTech-enabled</span>
                            </div>
                            <div class="prgcrds">
                                <div class="wefr">
                                    <h3>What do we offer</h3>
                                    <p>Domain-focused courses across BFSI, Fintech, Data Science, and Technology.</p>
                                </div>
                                <div class="wefr">
                                    <h3>Outcomes</h3>
                                    <p>Renewed purpose, technical upskilling, and stronger professional growth trajectory.</p>
                                </div>
                            </div>
                            <a class="primary_btn" href="#" tabindex="0"><span>Enquire Now</span> <svg width="10" height="15" viewBox="0 0 10 19" fill="none" xmlns="https://www.w3.org/2000/svg">
                            <path d="M1 1.5L9 9.5L1 17.5" stroke="currentColor" stroke-width="2" stroke-linejoin="round"></path>
                    ...
                    <div class="prflx" data-aos="fade-up">
                        ...
                        <div class="prgdtls">
                            <div class="prghd">
                               <h2>Industry Oriented Tracks</h2>
                               <p>Industry-focused programs created for universities to bridge academic study and career readiness.</p>
                            </div>
                            <div class="prgtgs">
                                <span>In-Person</span>
                                <span>Online</span>
                            ...
                            <div class="prgcrds">
                                <div class="wefr">
                                    <h3>What do we offer</h3>
                                    <p>Certifications, tracks, and workshops across BBA, MBA, and technical streams.</p>
                                </div>
                                <div class="wefr">
                                    <h3>Outcomes</h3>
                                    <p>Practical exposure aligning students with evolving industry demands.</p>
                                </div>
                            </div>
                            <a class="primary_btn" href="#" tabindex="0"><span>Enquire Now</span> <svg width="10" height="15" viewBox="0 0 10 19" fill="none" xmlns="https://www.w3.org/2000/svg">
                            <path d="M1 1.5L9 9.5L1 17.5" stroke="currentColor" stroke-width="2" stroke-linejoin="round"></path>
    ...
    <section>
        <div class="container">
            <div class="hdng text-center">
                <h2 class="blue_mnhdng">Our Collaboration with NDSC and Skills India</h2>
                <p>Industry recognized certifications you will earn</p>
            </div>

            <div class="nsdlflx">
                <div class="crtfimg">
                    <img src="<?php echo $base_url;?>assets/imgs/enterprise/enterprise-certificate.webp" alt="Certificate">
                </div>
                <div class="ctrfdlts">
                    <div class="inscrtf">
                        <h3>NSDL</h3>
                        <p>The National Skill Development Corporation (NSDC) is a public-private partnership under the Ministry of Skill Development and Entrepreneurship (MSDE), established to promote skill development by catalyzing the creation of large, quality vocational training institutions. NSDC funds and supports private sector initiatives to build scalable and sustainable skill development programs, working with training partners across diverse sectors to bridge the gap between industry needs and workforce capabilities.</p>
                    </div>
                    <div class="inscrtf">
                        <h3>Skill India</h3>
                        <p>Launched in 2015, the Skill India Mission is a flagship initiative of the Government of India aimed at empowering the country’s youth with employable skills through training, certification, and entrepreneurship support. It includes schemes like PMKVY (Pradhan Mantri Kaushal Vikas Yojana), National Apprenticeship Promotion Scheme (NAPS), and Skill Loan initiatives, all designed to make India a global hub for skilled manpower. The mission seeks to equip over 40 crore individuals with industry-relevant skills by 2025.</p>
                    </div>
                </div>
            </div>
        </div>
