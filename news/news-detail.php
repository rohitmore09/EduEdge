...
// Get current post
$stmt = $conn->prepare("SELECT posts.*, categories.name AS category FROM posts 
...
$relatedStmt = $conn->prepare("SELECT posts.*, categories.name AS category FROM posts
                               LEFT JOIN categories ON posts.category_id = categories.id
                               WHERE posts.category_id = ? AND posts.status = 'published' AND posts.slug != ?
                ...
                <div class="blgs-info">
                    <div class="blog-heading">
                        ...
                        <div class="tag-date">
                            ...
                            <!-- <p>Share <img src="<?php echo $base_url; ?>assets/imgs/blog/share-icon.svg" alt="Share"></p> -->
                        </div>
                    </div>
                    ...
                    <!-- Previous/Next Buttons (Optional: logic to fetch prev/next) -->
                    
                    <!-- <div class="nxbl-btn">
                        <div class="nvbtn">
                            <button><div class="ins-btnvs">
                                <svg width="10" height="15" viewBox="0 0 10 19"><path d="M1 1.5L9 9.5L1 17.5" stroke="currentColor" stroke-width="2" stroke-linejoin="round"></path></svg>
                        ...
                        <div class="nvbtn">
                            <button><div class="ins-btnvs">
                                <span>Next</span>
                                <svg width="10" height="15" viewBox="0 0 10 19"><path d="M1 1.5L9 9.5L1 17.5" stroke="currentColor" stroke-width="2" stroke-linejoin="round"></path></svg></div>
                                <h4>Next Title</h4>
                            </button>
                        </div>
                    </div> -->
                    ...
                    <div class="nxbl-btn">
                        ...
                        <div class="nvbtn">
                            <a href="<?php echo $base_url; ?>insights/<?php echo $prevPost['category']; ?>/<?php echo urlencode($prevPost['slug']); ?>">
                                <div class="ins-btnvs">
                                    <svg width="10" height="15" viewBox="0 0 10 19">
                ...
                <?php if ($relatedResult->num_rows > 0): ?>
                    <div class="related-blogs sidefix">
                        <div class="reltd-lst">
                            ...
                            <ul>
                                <?php while ($relatedPost = $relatedResult->fetch_assoc()): ?>
                                    <li>
                                        <h3 class="related-title"><?php echo htmlspecialchars($relatedPost['title']); ?></h3>
                                        <a class="secondary-btn" href="<?php echo urlencode($relatedPost['slug']); ?>">
                                            <span>Read More</span>
                                            <svg width="10" height="15" viewBox="0 0 10 19"><path d="M1 1.5L9 9.5L1 17.5" stroke="currentColor" stroke-width="2" stroke-linejoin="round"></path></svg>
                                        </a>
                                    </li>
