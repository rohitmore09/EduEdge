            ...
            <div class="plan_information">
                <div class="plan_details">
                    ...
                    <div class="inspgdtl">
                        ...
                        <p>Master Excel-based financial modelling to build dynamic, accurate models for valuation, forecasting, and decision-making. Learn techniques used by top analysts, bankers, and consultants worldwide.</p>
                    </div>
                    ...
                    <div class="wtlrn">
                        <div class="container">
                            ...
                            <div class="allr">
                                <a>Build 3-statement models</a>
                                <a>Apply DCF & LBO valuation</a>
                                <a>Perform scenario analysis</a>
                                <a>Conduct sensitivity testing</a>
                                <a>Create dashboards in Excel</a>
                                <a>Automate financial workflows</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sklslrn">
                        ...
                        <div class="rflx">
                            <div class="sklsimg">
                                <img src="<?php echo $base_url; ?>assets/imgs/enterprise/courses/consultant/exconsult.webp" alt="Skills">
                            </div>
                            <div class="sklst">
                                <ul>
                                    <li>
                                        ...
                                        <div class="pntrxn">
                                            <p>Financial statement linking</p>
                                        </div>
                                    </li>
                                    <li>
                                        <img src="<?php echo $base_url; ?>assets/imgs/enterprise/cfa/yltck.webp" alt="Tick icon" width="40" height="40">
                                        <div class="pntrxn">
                                            <p>Valuation modelling skills</p>
                                        </div>
                                    </li>
                                    <li>
                                        <img src="<?php echo $base_url; ?>assets/imgs/enterprise/cfa/yltck.webp" alt="Tick icon" width="40" height="40">
                                        <div class="pntrxn">
                                            <p>Scenario planning expertise</p>
                                        </div>
                                    </li>
                                    <li>
                                        <img src="<?php echo $base_url; ?>assets/imgs/enterprise/cfa/yltck.webp" alt="Tick icon" width="40" height="40">
                    ...
                    <div class="crkydtls">
                        ...
                        <div class="alkydtls">
                            <ul>
                                <li>Build income, balance sheet, and cash flow models</li>
                                <li>Apply DCF, LBO, and comparable company valuation techniques</li>
                                <li>Conduct scenario and sensitivity analysis for risk assessment</li>
                                <li>Create professional dashboards for clear financial insights</li>
                                <li>Automate repetitive modelling processes in Excel</li>
                                <li>Apply forecasting techniques for dynamic financial projections</li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="accordion" data-accordion>
                                    ...
                                    <div class="accordion-item">
                                        <div class="accordion-header">
                                            <h3>Does the course include 3-statement modelling?</h3>
                                        </div>
                                        <div class="accordion-content">
                                            <div class="acrd-ans">
                                                <p>Yes, it covers income statements, balance sheets, and cash flow models.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!--  -->
                                    ...
                                    <div class="accordion-item">
                                        <div class="accordion-header">
                                            <h3>Are valuation techniques like DCF included?</h3>
                                        </div>
                                        <div class="accordion-content">
                                            <div class="acrd-ans">
                                                <p>Yes, you will learn DCF, LBO, and comparable analysis methods.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!--  -->
                                    ...
                                    <div class="accordion-item">
                                        <div class="accordion-header">
                                            <h3>Will I learn dashboard creation in Excel?</h3>
                                        </div>
                                        <div class="accordion-content">
                                            <div class="acrd-ans">
                                                <p>Yes, the course includes data visualization and dashboard building.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!--  -->
                                    ...
                                    <div class="accordion-item">
                                        <div class="accordion-header">
                                            <h3>Is scenario analysis part of the curriculum?</h3>
                                        </div>
                                        <div class="accordion-content">
                                            <div class="acrd-ans">
                                                <p>Yes, scenario and sensitivity analysis are key topics covered.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!--  -->
                                    ...
                                    <div class="accordion-item">
                                        <div class="accordion-header">
                                            <h3>Is this course suitable for finance professionals?</h3>
                                        </div>
                                        <div class="accordion-content">
                                            <div class="acrd-ans">
                                                <p>Yes, it’s designed for analysts, bankers, and finance specialists.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!--  -->
                    ...
                    <div class="mkinvsm">
                        <div class="container">
                            <div class="dflex" data-aos="fade-up">
                                ...
                                <div class="infrast">
                                    <h2 class="blue_mnhdng admplnhd">Build professional-grade financial models and dashboards using advanced Excel techniques.</h2>
                                    <div class="invsbtns">
