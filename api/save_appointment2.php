...
// Prepare SQL Insert
$sql = "INSERT INTO appointments2
    (name, email, phone, courses, options, calendly_event_uri, calendly_event_start, calendly_event_end)
    VALUES
    (:name, :email, :phone, :courses, :options, :event_uri, :event_start, :event_end)";
...
try {
    ...
    //         courses : " . $formData['courses'] . " <br>
    //         options : " . $formData['options'] . " <br>
