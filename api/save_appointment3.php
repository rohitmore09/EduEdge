...
// Prepare SQL Insert
$sql = "INSERT INTO appointments3
    (name, email, phone, level, calendly_event_uri, calendly_event_start, calendly_event_end)
    VALUES
    (:name, :email, :phone, :level, :event_uri, :event_start, :event_end)";
