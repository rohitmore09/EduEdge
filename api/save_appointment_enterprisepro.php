...
// Prepare SQL Insert
$sql = "INSERT INTO enterpriese_pro 
    (name, email, phone, city, service, course, plan, cfa_level, calendly_event_uri, calendly_event_start, calendly_event_end)
    VALUES
    (:name, :email, :phone, :city, :service, :course, :plan, :cfa_level, :event_uri, :event_start, :event_end)";
...
try {
    $stmt->execute([
        ...
        ':cfa_level' => $formData['cfa_level'] ?? null,
        ':event_uri' => $eventUri,
        ':event_start' => $eventStart,
        ':event_end' => $eventEnd,
    ]);
    $admin_subject = "Eduedge | Appointment | Enterprise Pro";
