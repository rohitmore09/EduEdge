...
$sql = "INSERT INTO appointments 
    (name, email, phone, city, service, board, other_board, standard, ug_stream, other_stream, qualification, other_qualification, experience, interest, calendly_event_uri, calendly_event_start, calendly_event_end)
    VALUES
    (:name, :email, :phone, :city, :service, :board, :other_board, :standard, :ug_stream, :other_stream, :qualification, :other_qualification, :experience, :interest, :event_uri, :event_start, :event_end)";
...
try {
    $stmt->execute([
        ...
        ':other_board' => $formData['other_board'] ?? null,
        ':standard' => !empty($formData['standard']) ? $formData['standard'] : ($formData['ug_standard'] ?? null),
        ':ug_stream' => $formData['ug_stream'] ?? null,
        ':other_stream' => $formData['other_stream'] ?? null,
    ...
    $admin_subject = "Eduedge | Appointment";
    ...
    $fields = [
        ...
        'Other Board' => $formData['other_board'] ?? '',
        'Standard' => $formData['standard'] ?? '',
        'UG Stream' => $formData['ug_stream'] ?? '',
        'Other Stream' => $formData['other_stream'] ?? '',
        'Qualification' => $formData['qualification'] ?? '',
        'Other Qualification' => $formData['other_qualification'] ?? '',
