...
// Prepare SQL Insert
$sql = "INSERT INTO enterprise_pro_contact
    (name, email, phone, service, certification, course, cfa_level, calendly_event_uri, calendly_event_start, calendly_event_end)
    VALUES
    (:name, :email, :phone, :service, :certification, :course, :cfa_level, :event_uri, :event_start, :event_end)";
...
try {
    ...
    // === Email notification ===
    $admin_subject = "Eduedge | Appointment (Enterprise Pro Contact)";
    $admin_message = "Hello Team,<br><br>New appointment enquiry:<br><br>";
    ...
    $admin_message .= "<br><br>Thank you,<br>Eduedge";
