<div class="all_crsse slick-slider">
                                <div class="crsse">
                                    <div class="crse_img">
                                        <img src="<?php echo $base_url; ?>assets/imgs/enterprise/courses/data-science/essential-python" alt="Certificate image" width="384" height="160">
                                        <small>Data Scientist</small>
                                    </div>
                                    <div class="crse-hd">
                                        <h2>Essential Python for<br> Data Science</h2>
                                ...
                                <div class="crsse">
                                    ...
                                    <div class="crse-hd">
                                        <h2>Statistics for Data<br> Science</h2>
                            ...
                            <!-- certificate-cards -->
                                <div class="crsse">
                                    ...
                                    <div class="crse-hd">
                                        <h2>Machine Learning for<br> Data Science</h2>
                            ...
                            <!-- certificate-cards -->
                                <div class="crsse">
                                    ...
                                    <div class="crse-hd">
                                        <h2>Big Data & Cloud<br> Computing</h2>
                            ...
                            <!-- certificate-cards -->
                                <div class="crsse">
                                    ...
                                    <div class="crse-hd">
                                        <h2>NLP for Text<br> Processing</h2>
