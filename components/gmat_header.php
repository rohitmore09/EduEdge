    ...
    <div class="container">
        <div class="main_header">
            <div class="logo">
                ...
                <h2 class="crsname">GMAT Prep</h2>
            </div>
            <ul class="main_nav">
                <li class="dn"><i class="fas fa-home"></i><a href="<?php echo $base_url; ?>">Home</a></li>
                <li><a href="<?php echo $base_url;?>top-prep/gmat.php" class="ov_active">Overview</a></li>
                <li><a href="<?php echo $base_url;?>top-prep/gmat/private-tutoring.php" class="pt_active">Private Tutoring</a></li>
                <li><a href="<?php echo $base_url;?>top-prep/gmat/online-offline.php" class="cls_active">Online/Offline Classes</a></li>
                <li><a href="<?php echo $base_url;?>top-prep/gmat/self-paced.php" class="sp_active">Self Placed</a></li>
