    ...
    <div class="container">
        <div class="main_header">
            <div class="logo">
                ...
                <h2 class="crsname">SAT PREP</h2>
            </div>
            <ul class="main_nav">
                <li class="dn"><i class="fas fa-home"></i><a href="<?php echo $base_url; ?>">Home</a></li>
                <li><a href="<?php echo $base_url;?>top-prep/sat-prep.php" class="ov_active">Overview</a></li>
                ...
                <li><a href="<?php echo $base_url;?>top-prep/sat/self-paced.php" class="sp_active">Self Paced</a></li>
                ...
                <li class="consultation_btn"><a href="<?php echo $base_url;?>top-prep/sat/book-consultation.php"" class="primary__btn"><span>Book a Consultation</span> <svg width="10" height="15" viewBox="0 0 10 19" fill="none" xmlns="https://www.w3.org/2000/svg">
