    ...
    <div class="container">
        <div class="main_header">
            <div class="logo">
                ...
                <h2 class="crsname">GRE Prep</h2>
            </div>
            <!-- <div class="crsname"><a href="#" class="mnactive">GRE</a></div> -->
            <ul class="main_nav">
                <li class="dn"><i class="fas fa-home"></i><a href="<?php echo $base_url; ?>">Home</a></li>
                <li><a href="<?php echo $base_url;?>top-prep/gre.php" class="ov_active">Overview</a></li>
                <li><a href="<?php echo $base_url;?>top-prep/gre/private-tutoring.php" class="pt_active">Private Tutoring</a></li>
                <li><a href="<?php echo $base_url;?>top-prep/gre/online-offline.php" class="cls_active">Online/Offline Classes</a></li>
                <li><a href="<?php echo $base_url;?>top-prep/gre/self-paced.php" class="sp_active">Self Placed</a></li>
