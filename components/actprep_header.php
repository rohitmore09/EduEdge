    ...
    <div class="container">
        <div class="main_header">
            <div class="logo">
                ...
                <h2 class="crsname">ACT PREP</h2>
            </div>
            <ul class="main_nav">
                <li class="dn"><i class="fas fa-home"></i><a href="<?php echo $base_url; ?>">Home</a></li>
                <li><a href="<?php echo $base_url;?>top-prep/act-prep.php" class="ov_active">Overview</a></li>
                <li><a href="<?php echo $base_url;?>top-prep/act/self-paced.php" class="sp_active">Self Paced</a></li>
                <li><a href="<?php echo $base_url;?>top-prep/act/private-tutoring.php" class="pt_active">Private Tutoring</a></li>
                <li class="dn"><a href="<?php echo $base_url;?>contact.php">Contact</a></li>
                <!-- <li><a href="#" class="cls_active">Online/Offline Classes</a></li> -->
