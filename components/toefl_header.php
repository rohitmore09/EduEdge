    ...
    <div class="container">
        <div class="main_header">
            <div class="logo">
                ...
                <h2 class="crsname">TOEFL</h2>
            </div>
            <ul class="main_nav">
                <li class="dn"><i class="fas fa-home"></i><a href="<?php echo $base_url; ?>">Home</a></li>
                <li><a href="<?php echo $base_url;?>top-prep/toefl.php" class="ov_active">Overview</a></li>
                <!-- <li><a href="<?php echo $base_url;?>top-prep/sat/private-tutoring.php" class="pt_active">Private Tutoring</a></li> -->
                <li><a href="<?php echo $base_url;?>top-prep/toefl/toefl-online.php" class="cls_active">Online/Offline Classes</a></li>
