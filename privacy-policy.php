...
<head>
    ...
    <title>Privacy Policy | EduEdge Pro</title>
    <!-- css -->
    ...
    <div class="container">
        ...
        <div class="privacy_dv">
            ...
            <ul>
                ...
                <li>Reviews or ratings, syllabus and course preferences, account settings, (including preferences set in the " Account " section of our Website); and</li>
            ...
            <p>The user full name and his/her display picture can be publicly displayed on the Website. Depending on what profile and what services they are seeking, EduEdge Pro can ask for more information relating to address, billing information, certificates, past employment information etc.</p>

            <p>EduEdge Pro can use technologies such as cookies, clear gifs, log files, and flash cookies for several purposes, including to help understand how you interact with our site and services, in order to provide a better experience.</p>

            <h3>USAGE AND RETENTION OF INFORMATION</h3>
            ...
            <p>We have appropriate security measures to prevent your Personal Data from being accidentally lost or used or accessed unlawfully. Processing your Personal Data will be done only in an authorised manner and subject to a duty of confidentiality. We also have procedures–in-place to deal with any suspected data security breach. We will notify you about any applicable regulator of a suspected data security breach where we are legally required to do so. Notwithstanding anything contained anywhere in this Agreement; we cannot assure absolute security to your personal data and by entering into or by logging into our website, you explicitly agree not to sue us for any data breach.</p>
            ...
            <p>The Site contains copyrighted material, trademarks and other proprietary information, including, but not limited to, text, software, photos, video, graphics, music, sound, and the entire contents of EduEdge Pro is protected by copyright as a collective work under the applicable copyright laws. EduEdge Pro owns a copyright in the selection, coordination, arrangement and enhancement of such content, as well as copyright or license to use in the content original to it. You may not modify, publish, transmit, participate in the transfer or sale, create derivative works, or in any way exploit, any of the content, in whole or in part. You may download / print / save copyrighted material for your personal use only. Except as otherwise expressly stated under copyright law, no copying, redistribution, retransmission, publication or commercial exploitation of downloaded material without the express permission of EduEdge Pro is permitted. If copying, redistribution or publication of copyrighted material is expressly permitted by EduEdge Pro, then no changes in or deletion of author attribution, trademark legend or copyright notice shall be made.</p>

            <p>You acknowledge that you do not acquire any ownership rights by downloading copyrighted material. Trademarks that are located within or on our Website or a website otherwise owned or operated in conjunction with EduEdge Pro shall not be deemed to be in the public domain but rather the exclusive property of EduEdge Pro, unless such site is under license from the trademark owner thereof in which case such license is for the exclusive benefit and use of EduEdge Pro, unless otherwise stated.</p>

            <p>EduEdge Pro does not have any express burden or responsibility to provide you with indications, markings or anything else that may aid you in determining whether the material in question is copyrighted or trademarked. You shall be solely liable for any damage resulting from any infringement of copyrights, trademarks, proprietary rights or any other harm resulting from such a submission. By submitting material to any public area of the Website, you warrant that the owner of such material has expressly granted EduEdge Pro the royalty-free, perpetual, irrevocable, non-exclusive right and license to use, reproduce, modify, adapt, publish, translate and distribute such material (in whole or in part) worldwide and/or to incorporate it in other works in any form, media or technology now known or hereafter developed for the full term of any copyright that may exist in such material. You also permit any other end user to access, view, store or reproduce the material for that end user's personal use. You hereby grant EduEdge Pro, the right to edit, copy, publish and distribute any material made available on the Website by you. If you come across any abuse or violation of these Terms, please report to info@eduedgepro.com.</p>
            ...
            <p>In accordance with Information Technology Act 2000 and rules made there under, the name and contact details of the Grievance Officer are provided below: info@eduedgepro.com. </p>

            <h3>CONSENT TO THIS POLICY</h3>
            <p>The Terms of Use Agreement is incorporated herein by reference in its entirety.</p>

            <h3>GENERAL</h3>
            <h4>Modification:</h4>
            <p>We may at any time modify the Terms of Use of our Website without any prior notification to you. Should you wish to terminate your account due to a modification to the Terms or the Privacy Policy, you may do so email us at info@eduedgepro.com.  However, if you continue to use the service you shall be deemed to have agreed to accept and abide by the modified Terms of this Website.</p>

            <h3>PRIVILEGED/EXCLUSIVE SERVICE:</h3>
            <p>By having a EduEdge Pro account, you have explicitly given consent for us to capture images (followed by analysis), camera/mic permissions to make video calls and record the same.</p>

            <h3>EduEdge Pro MAY DISCLOSE INFORMATION:</h3>
            ...
            <p>This contract shall be subject to the exclusive jurisdiction of courts in Bangalore, Karnataka, India and shall be governed by the Indian laws.</p>
        </div>
    </div>
</section>
