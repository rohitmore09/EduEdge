...
<head>
    ...
    <title>ACT Self Paced | Eduedge Pro</title>
    <meta name="description" content="">
  <meta name="robots" content="index, follow">
  <meta property="og:title" content="ACT Self Paced | Eduedge Pro">
  <meta property="og:description" content="">
  <meta property="og:image" content="https://eduedgepro.com/assets/imgs/logo/logo.svg">
  <meta property="og:url" content="https://eduedgepro.com/top-prep/act/self-paced.php">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="ACT Self Paced | Eduedge Pro">
  ...
  <meta name="twitter:image" content="https://eduedgepro.com/assets/imgs/logo/logo.svg">
    ...
    <!-- css -->
     <style>
        .sp_active{color:var(--primary) !important;}
     </style>
</head>

<body>
    <!-- Header -->
    <?php include '../../components/actprep_header.php'; ?>
    <!-- Header -->
    ...
    <div class="satbanner">
        <picture>
            <source media="(min-width: 769px)" srcset="<?php echo $base_url; ?>assets/imgs/satprep/banner/self-paced.webp">
            <source media="(max-width: 768px)" srcset="<?php echo $base_url; ?>assets/imgs/satprep/banner/self-pacedmb.webp">
            <img src="<?php echo $base_url; ?>assets/imgs/satprep/banner/self-paced.webp" alt="Banner" class="bannerimg">
        </picture>
        <div class="container">
             <!-- breadcrumb -->
        <div class="breadcrumb">
                <ul class="breadcrumb-item">
                    ...
                    <li>
                        <a href="<?php echo $base_url; ?>top-prep/act-prep.php">ACT</a>
                        <svg width="10" height="15" viewBox="0 0 10 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 1.5L9 9.5L1 17.5" stroke="currentColor" stroke-width="2" stroke-linejoin="round" />
                        </svg>
                    </li>
                    <li>
                        <a class="active">ACT Self Paced</a>
                    </li>
                </ul>
        </div>
        <!-- breadcrumb -->
            <div class="satflx">
                <div class="bannerlft">
                    <div class="baner-dtls">
                        <h1>Flexible ACT Prep for<br> Independent Learners</h1>
                        <p>Study anytime, anywhere with trusted Kaplan resources.</p>
    ...
    <section class="greysec overflow">
        <div class="container">
            <div class="kplna-card">
                ...
                <div class="klpn_imgLogo">
                    ...
                    <div class="crd_tl">
                        <h2>Kaplan ACT Prep On Demand</h2>
                        <p>Course Features</p>
                    </div>
                    <div class="crd-points">
                        <ul>
                            <li>For independent learners who want flexibility and trusted resources</li>
                            <li>Structured video lessons and foundational guidance</li>
                            <li>Ideal for students targeting ACT scores of 25+</li>
                            <li>4 full-length mock ACT tests included</li>
                            <li>Access to Kaplan’s On Demand learning platform</li>
                        </ul>
                    </div>
                ...
                <div class="kpln_dtlimg" data-aos="fade-right">
                    <img src="<?php echo $base_url; ?>assets/imgs/satprep/selfpaced-course-card.webp" class="covimg" alt="Biology">
                </div>
                <!--  -->
                <!-- <div class="crd_kpln">
                <div class="klpn_imgLogo">
        ...
        <div class="container">
            ...
            <div class="online_prep rflx"  data-aos="fade-up">
                <div class="online_img">
                    <div class="imgsin">
                        <img src="<?php echo $base_url; ?>assets/imgs/satprep/online-prep-card-img.webp" alt="Online Perp" width="528" height="472">
                    </div>
                </div>
    ...
    <!-- Price table -->
    <section id="programs" class="sat-plan">
        <div class="container">
            <div class="hdng text-center" data-aos="fade-up">
                <h2 class="blue_mnhdng">Which ACT Course Suits You?</h2>
                <p>Explore your options before choosing your prep path - compare flexibility, features and more, before enrolling.</p>
            </div>
            <div class="price_tabel" data-aos="fade-up">
                <div class="rflx">
                    ...
                    <div class="right_txt">
                        <div class="mnprc">
                            <div class="prcdtl w-50">
                                <h3 class="prchd">Kaplan ACT Prep</h3>
                                <p>Foundational guidance and 
                                    access to key resources</p>
                                <p>25+</p>
                                <p>Self-paced with Kaplan on-demand ACT Prep</p>
                            ...
                            <div class="prcdtl w-50">
                                ...
                                <p><img src="<?php echo $base_url; ?>assets/imgs/satprep/icons/tick.svg" alt="Tick"></p>
                                <div class="actprl">
                                    <p>INR<span class="fntbg">1,85,000</span> + GST</p>
                                    <!-- <button class="prcbtn"><span>Buy Now</span><svg width="10" height="15" viewBox="0 0 10 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 1.5L9 9.5L1 17.5" stroke="currentColor" stroke-width="2" stroke-linejoin="round" />
                                        </svg></button> -->
                                </div>
                ...
                <div class="accordion" data-accordion>
                    <div class="accordion-item">
                        <div class="accordion-header">
                            <div class="acrd-img">
                                <img src="<?php echo $base_url; ?>assets/imgs/top-prep/icons/1-1private.svg" alt="Accordion Icon">
                            </div>
                            <div class="acrdhd">
                                <h4>Personalized 1:1 Tutoring</h4>
                            </div>
                        </div>
                        <div class="accordion-content">
                            <div class="ins-content">
                            <p>Work one-on-one with ACT experts who tailor every session to your pace, strengths, and challenges. Get ongoing guidance, motivation, and strategy that’s built around your unique score goals.</p>
                            </div>
                        </div>
                    </div>
                    <!--  -->
                    <div class="accordion-item">
                        <div class="accordion-header">
                            ...
                            <div class="acrdhd">
                                <h4>Expert-Backed Strategies</h4>
                            </div>
                        </div>
                        <div class="accordion-content">
                            <div class="ins-content">
                            <p>Learn high-impact strategies developed by Ivy League mentors to boost speed, accuracy, and section-specific performance. Master time management, question selection, and test-day readiness.</p>
                            </div>
                        </div>
                    </div>
                    <!--  -->
                    <div class="accordion-item">
                        <div class="accordion-header">
                            ...
                            <div class="acrdhd">
                                <h4>Full-Length Simulations</h4>
                            </div>
                        </div>
                        <div class="accordion-content">
                           <div class="ins-content">
                            <p>Train with up to 10 mock ACT exams that replicate the actual test environment. Build exam stamina and confidence while identifying real-time areas for improvement.</p>
                            </div>
                        </div>
                    </div>
                    <!--  -->
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="ins-content">
                           <p>Follow structured 3- or 4-week plans aligned to your target score timeline. These efficient roadmaps balance tutoring, practice, and revision for maximum impact.</p>
                            </div>
                        </div>
                    </div>
                    <!--  -->
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="ins-content">
                            <p>Gain access to Kaplan’s full prep suite—including On Demand classes, ACT prep books, and Barron’s guides—ensuring no topic or technique is left out.</p>
                            </div>
                        </div>
                    </div>
                    <!--  -->
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                           <div class="ins-content">
                            <p>Stay on top of your improvement with tools that measure score growth and skill mastery. Adjust strategies and focus areas as needed for consistent progress.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="testimonialcard">
                        <div class="tstflx">
                            ...
                            <div class="tstdtls">
                                <p>"I started with a 1150 on my practice test, but after completing this SAT prep course, I scored a 1530! The structured lessons, timed practice tests, and expert strategies helped me stay focused and confident."</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="faqsection" data-aos="fade-up">
                <div class="accordion" data-accordion>
                    ...
                    <div class="accordion-item">
                        <div class="accordion-header">
                            <h3>What is the ACT and what does it test?</h3>
                        </div>
                        <div class="accordion-content">
                            <div class="acrd-ans">
                                <p>The ACT is a standardized test for college admissions in the U.S. It measures English, Math, Reading, and Science skills, with an optional Writing section. Each section is scored on a 1–36 scale, and the Writing section is scored separately.</p>
                            </div>
                        </div>
                    </div>
                    <!--  -->
                    ...
                    <div class="accordion-item">
                        <div class="accordion-header">
                            <h3>How long is the ACT and what’s the format?</h3>
                        </div>
                        <div class="accordion-content">
                            <div class="acrd-ans">
                                <p>The ACT lasts about 3 hours (plus 40 minutes if you take the Writing section). It consists of four multiple-choice sections: English (45 mins), Math (60 mins), Reading (35 mins), and Science (35 mins), plus an optional Writing section.</p>
                            </div>
                        </div>
                    </div>
                    <!--  -->
                    ...
                    <div class="accordion-item">
                        <div class="accordion-header">
                            <h3>Why should I take the ACT?</h3>
                        </div>
                        <div class="accordion-content">
                            <div class="acrd-ans">
                                <p>A strong ACT score strengthens college applications, demonstrates academic readiness, and improves chances for scholarships and honors programs. It also offers flexibility with multiple test dates and no penalty for guessing.</p>
                            </div>
                        </div>
                    </div>
                    <!--  -->
                    ...
                    <div class="accordion-item">
                        <div class="accordion-header">
                            <h3>How does ACT help with scholarships?</h3>
                        </div>
                        <div class="accordion-content">
                            <div class="acrd-ans">
                                <p>Many U.S. universities and scholarship providers use ACT scores to determine merit-based financial aid. A higher score can improve eligibility and increase your scholarship award amount.</p>
                            </div>
                        </div>
                    </div>
                    <!--  -->
                    ...
                    <div class="accordion-item">
                        <div class="accordion-header">
                            <h3>What is Kaplan ACT Prep On Demand?</h3>
                        </div>
                        <div class="accordion-content">
                            <div class="acrd-ans">
                                <p>It’s a flexible, self-paced online course featuring Kaplan’s structured video lessons, practice tools, and test simulations. It’s ideal for students targeting ACT scores of 25+ who prefer learning independently.</p>
                            </div>
                        </div>
                    </div>
                    <!--  -->
                    ...
                    <div class="accordion-item">
                        <div class="accordion-header">
                            <h3>Who should take the Self-Paced plan?</h3>
                        </div>
                        <div class="accordion-content">
                            <div class="acrd-ans">
                                <p>Students who are motivated, comfortable with independent learning, and looking for high-quality resources from a globally trusted test-prep leader like Kaplan will benefit from this plan.</p>
                            </div>
                        </div>
                    </div>
                    <!--  -->
                    ...
                    <div class="accordion-item">
                        <div class="accordion-header">
                            <h3>What study materials are included in this course?</h3>
                        </div>
                        <div class="accordion-content">
                            <div class="acrd-ans">
                                <p>You’ll get Kaplan’s learning videos, prep books, chapter-wise notes, 1,000+ practice questions, full-length mock tests, and progress tracking tools. Everything is designed to simulate real test-day conditions.</p>
                            </div>
                        </div>
                    </div>
                    <!--  -->
                    ...
                    <div class="accordion-item">
                        <div class="accordion-header">
                            <h3>How many practice tests do I get?</h3>
                        </div>
                        <div class="accordion-content">
                            <div class="acrd-ans">
                                <p>This plan includes 4 full-length mock ACT exams along with chapter-wise practice sets and a question bank covering all ACT topics.</p>
                            </div>
                        </div>
                    </div>
                    <!--  -->
